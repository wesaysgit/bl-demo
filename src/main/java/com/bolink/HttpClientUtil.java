...
public class HttpClientUtil {
    ...
    static {
        ...
        RequestConfig defaultConfig = RequestConfig.custom().setConnectTimeout(2000)
                .setConnectionRequestTimeout(500)
                .setSocketTimeout(3000)
                .build();
        //通过连接池管理来创建httpclient
        //client = HttpClients.custom().setConnectionManager(cm).build();
        client = HttpClients.custom().setConnectionManager(cm).setDefaultRequestConfig(defaultConfig).build();
    }
    ...
    public static String wuxiPostParameters(String url, String parameterStr) throws Exception {
        return wuxiPost(url, parameterStr, "application/json", DEFAULT_CHARSET, connTimeout, readTimeout);
    }
    ...
    public static String postWithHeard(String url,String headerKey,String hearder,String content){
            ...
            } catch (SocketTimeoutException | ConnectTimeoutException | NoHttpResponseException outEx) {
                logger.error("postWithHeard请求超时(5000)url: "+url+", error: "+outEx.getMessage(), outEx);
            } catch (Exception e) {
                logger.error("postWithHeard>>>error: ", e);
            }finally{
                if(post!=null)
                    post.releaseConnection();
            }
     ...
     * @throws Exception
     */
    public static String postForms(String url, Map<String, String> params, Map<String, String> headers, Integer connTimeout,Integer readTimeout) throws Exception {
     ...
     * @throws Exception
     */
    public static String wuxiPost(String url, String body, String mimeType, String charset, Integer connTimeout, Integer readTimeout) throws Exception {
        CloseableHttpClient client = null;
        HttpPost post = new HttpPost(url);
        String result = "";
        try {
    ...
    public static String postHttpsJSON(String url, String ctype, byte[] content,
        ...
        try {
            try{
                ...
                logger.info("GET_CONNECTOIN_ERROR, URL=" + url+", error: "+e.getMessage());
                throw new IOException("GET_CONNECTOIN_ERROR, URL=" + url, e);
            }catch(Exception e){
    ...
    public static String httpPostWithJsonUTF8(String url, String json, Integer connTimeout, Integer readTimeout) {
        //第一步：创建HttpClient对象
        ...
        //第三步：给httpPost设置JSON格式的参数
        httpPost.setHeader("Content-Type", "application/json");
        StringEntity requestEntity = new StringEntity(json, "utf-8");//ContentType.APPLICATION_JSON
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpPost)){
            ...
            logger.info("httpPostWithJsonUTF8>>> 未取到所需结果数据{url:"+url+",statusCode:"+response.getStatusLine().getStatusCode()+"}");
            return null;
        } catch (Exception e) {
            logger.error("http client post>>>error: "+e.getMessage(), e);
            throw new RuntimeException("httpPostWithJsonUTF8-error", e);
        }
    }
    ...
    public static String formUpload(String urlStr, Map<String, String> textMap,
        ...
        try {
            ...
            logger.error("发送POST请求出错>>>error: ", e);
        } finally {
            if (conn != null) {
                conn.disconnect();
                conn = null;
    ...
    public static String doPost(String url, Map<String, String> param) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpPost)){
            ...
            logger.error("doPost请求出错>>>error: ", e);
        }
        return resultString;
    }
}
