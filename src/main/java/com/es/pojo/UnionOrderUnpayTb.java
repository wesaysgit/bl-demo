...
public class UnionOrderUnpayTb {
...
//                "tableName='" + tableName + '\'' +
                ...
                ", localId='" + localId + '\'' +
//                ", duration=" + duration +
//                ", freeOutTime=" + freeOutTime +
                ", queryTime=" + queryTime +
                ", queryPriceTime=" + queryPriceTime +
//                ", derateMoney=" + derateMoney +
//                ", derateDuration=" + derateDuration +
                ", price=" + price +
...
//                ", tradeNo='" + tradeNo + '\'' +
//                ", hideInparkInfo=" + hideInparkInfo +
//                ", picUrl='" + picUrl + '\'' +
//                ", subNumber='" + subNumber + '\'' +
//                ", multiplePrepay=" + multiplePrepay +
//                ", deduction=" + deduction +
                '}';
    }
