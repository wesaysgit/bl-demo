...
public class TimeTools {
	...
	// 时间格式数组
	private static String[] formatArray = { "yyyyMMdd","yyyy-MM-dd", "yyyy-MM-dd HH:mm",
			"yyyy-MM-dd HH:mm:ss", "yy-MM-dd HH:mm", "yyyyMMdd HH:mm", "yyyy-MM-dd HH","yyyy-MM-dd HH:mm:ss.SSS","yyyyMMddHHmmssSSS" ,"yyyyMMddHHmmss"};
	...
	public static Long yyyyMMddHHmmssLong(String timeStr){
...
//				calendar.set(Calendar.MINUTE, calendar.get(Calendar.MINUTE)+1);
	...
	public static String getTimeYYYYMMDD(Long milliSeconds)
	{
		String s = getTimeStr_yyyy_MM_dd(milliSeconds);
		s = s.replaceAll("-", "").replaceAll(":", "").replaceAll(" ","").trim();
		return s;
	}

	public static void main(String[] args) {
		String timeYYYYMMDDHHMMSS = getTimeYYYYMMDDHHMMSS();
		String timeYyyyMMddTHHmmss = getTime_yyyyMMddTHHmmss(new Date().getTime());
		String format = DateUtil.format(new Date(), "yyyyMMddHHmmss");
		System.out.println(timeYYYYMMDDHHMMSS);
	 ...
	 * @return 格式化后的时间字符串 yyyy-MM-dd
	 */
	public static String getTimeYYYYMMDDHHMMss(Long milliSeconds) {

		return secondsToDateStr(milliSeconds, "yyyyMMddHHmmss");
	}
